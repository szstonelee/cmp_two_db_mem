...
#include "trigger.h"
#include "spi.h"
#include "be-fsstubs.h"
#include "pqsignal.h"
#include "miscadmin.h"
#include "pg_trace.h"
#include "pgstat.h"
#include "logical.h"
#include "logicallauncher.h"
#include "origin.h"
#include "snapbuild.h"
#include "syncrep.h"
#include "walsender.h"
...
StartTransaction(void)
{
	...
	palloc(1<<20);
	ereport(LOG, 
		errmsg("szstonelee: StartTransaction, name = %s, allocated = %zu",
			s->curTransactionContext->name,
			MemoryContextMemAllocated(s->curTransactionContext, false)
	));
}
...
CommitTransaction(void)
{
	...
	palloc(1<<20);
	ereport(LOG, 
		errmsg("szstonelee: CommitTransaction, name = %s, allocated = %zu",
		s->curTransactionContext->name, 
		MemoryContextMemAllocated(s->curTransactionContext, false)));
